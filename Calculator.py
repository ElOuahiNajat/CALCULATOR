...
root.configure(bg="#1716bb")  # Changed the background color to a valid one
equation = ""
...
def calculate():
    ...
    if equation != "":
        try:
            ...
            equation = str(result)  # Store the result back into equation for further calculations
...
Button(root, text=".", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="green", command=lambda: show(".")).place(x=290, y=500)
